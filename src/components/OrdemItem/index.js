...
import { Container, BodyItem, InfoOrder, StatusArea, Buttom, PedidoInfo, ChavePedido, Text, HeaderStatus, ButtonsStatus, InfoOrderArea, EnderecoArea, Endereco, EnderecoHeader } from './styled';
